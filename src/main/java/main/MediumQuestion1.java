...
class PrivilegeCustomer extends Customer {
	PrivilegeCustomer(String name, String address, Integer age, String mobile) {
		...
		Double getBillAmount(Double amount) { //edit as per the Question 
	...
	public static void main(String[] args) {
		...
		switch (select) {
			case 1:
				...
				System.out.println(cust.toString()+"\n"+"Your Bill Amount is  RS."+purchasedAmt);
				System.out.println("Congrats! As you are a Privileged customer, you are eligible for a discount!");
				System.out.println("You have to pay Rs " + cust.getBillAmount(purchasedAmt));
			...
			case 2:
				...
				System.out.println("You have to pay Rs " + cust1.getBillAmount(purchasedAmt));
				break;
